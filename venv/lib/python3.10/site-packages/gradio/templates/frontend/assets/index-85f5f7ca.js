...
const ENTRY_CSS = "./assets/index-a0018f51.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-39333b6d.js').then(n => n.I),true?["./Index-39333b6d.js","./Index-4d9f344e.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-85f5f7ca.js.map
